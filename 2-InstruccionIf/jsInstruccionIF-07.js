...
IF 07. Al ingresar una edad menor a 18 años y un estado civil distinto a "Soltero", 
...
function mostrar()
{
	...
	{
		mensajePequeño = "Es muy pequeño para NO ser Soltero. ";
	}


 	 mensajeAlerta = mensaje + mensajeDos + mensajeTres + mensajeCuatro + mensajeCivil + mensajePequeño;
